...
@interface DDPullView () <UITableViewDelegate, UITableViewDataSource>
...
- (void)showFrom:(UIView *)from alignStyle:(CPAlignStyle)style
{
    ...
    containerViewFrame.origin.y =  CGRectGetMaxY(newFrame) + 3;
    ...
    switch (style) {
        ...
        case CPAlignStyleLeft:
        {
            ...
            frame.origin.x = CGRectGetMidX(newFrame)-10;
