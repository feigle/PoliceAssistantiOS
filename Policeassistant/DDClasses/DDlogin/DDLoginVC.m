...
- (void)viewDidLoad {
    ...
    user=[self createTextFielfFrame:CGRectMake(60, 19, loginView.frame.size.width-60, 18) font:[UIFont systemFontOfSize:18] placeholder:@""];
    user.delegate=self;
  //  user.keyboardType=UIKeyboardTypeDefault;
    ...
    pwd=[self createTextFielfFrame:CGRectMake(60, 57, loginView.frame.size.width-60, 18) font:[UIFont systemFontOfSize:18]  placeholder:@"" ];
