...
#define kMainPageDistance   [[UIScreen mainScreen] bounds].size.width/4   //打开左侧窗时，中视图(右视图)露出的宽度
...
@interface DDLeftSliderVC ()<UIGestureRecognizerDelegate,UITabBarControllerDelegate>
{
                     ...
                     andMainView:(UITabBarController *)mainVC
{
    if(self = [super init]){
        ...
        self.leftTableview.backgroundColor = RGB(10, 9, 25);
        //self.leftTableview.frame = CGRectMake(kMainPageDistance, (kScreenHeight - 300)/2, kScreenWidth - kMainPageDistance*1.5, 300);
        self.leftTableview.frame =CGRectMake(0, 0, self.view.frame.size.width*0.75+1, self.view.frame.size.height);
        ...
        [DDLeftSliderManger  sharedInstance].LeftSlideVC = self;
        [DDLeftSliderManger sharedInstance].mainNavigationController = mainVC.viewControllers.firstObject;
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController{
    [DDLeftSliderManger sharedInstance].mainNavigationController = (UINavigationController *)viewController;
}
