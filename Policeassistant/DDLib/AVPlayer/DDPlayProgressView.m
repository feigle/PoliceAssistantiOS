...
@implementation DDPlayProgressView
...
- (void)resetAllSubviews{
    ...
    [_progressSlider setThumbImage:[UIImage imageNamed:@"av_slider"] forState:UIControlStateNormal];
    [_progressSlider setThumbImage:[UIImage imageNamed:@"av_slider"] forState:UIControlStateHighlighted];
    ...
    [_fullBtn setImage:[UIImage imageNamed:@"av_full"] forState:UIControlStateNormal];
