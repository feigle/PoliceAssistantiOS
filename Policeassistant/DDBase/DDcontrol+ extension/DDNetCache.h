...
typedef void(^DDNetworkCacheCompletionBlock)(BOOL result);
@interface DDNetCache : NSObject
/**
 ...
 */
+(void)save_asyncJsonResponseToCacheFile:(id)jsonResponse andURL:(NSString *)URL completed:(DDNetworkCacheCompletionBlock)completedBlock;
